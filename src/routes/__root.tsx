...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MayScribe | Medical Dictation" },
      { name: "description", content: "HIPAA-aligned, self-hosted clinical dictation with confidence-aware review, medication intelligence, and native EHR insertion." },
      { name: "author", content: "MayScribe" },
      { property: "og:title", content: "MayScribe | Medical Dictation" },
      { property: "og:description", content: "HIPAA-aligned, self-hosted clinical dictation with confidence-aware review, medication intelligence, and native EHR insertion." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "MayScribe | Medical Dictation" },
